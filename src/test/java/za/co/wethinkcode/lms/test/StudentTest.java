...
//        assertEquals(5, testSummary.getTestsFoundCount(), "Expected exactly 5 test cases.");
//        assertTrue(testSummary.getTestsFoundCount() > 3, "Expected more than 3 test cases."); //we want at least 3 individual tests
